...
export const WORKSPACE_CATALOG = Object.freeze({
  "@clerk/backend": "^3.4.7",
  "@eslint/js": "^9.17.0",
  "@holo-js/adapter-next": "^0.1.5",
  "@holo-js/adapter-nuxt": "^0.1.5",
  "@holo-js/adapter-sveltekit": "^0.1.5",
  "@holo-js/auth": "^0.1.5",
  "@holo-js/auth-clerk": "^0.1.5",
  "@holo-js/auth-social": "^0.1.5",
  "@holo-js/auth-social-apple": "^0.1.5",
  "@holo-js/auth-social-discord": "^0.1.5",
  "@holo-js/auth-social-facebook": "^0.1.5",
  "@holo-js/auth-social-github": "^0.1.5",
  "@holo-js/auth-social-google": "^0.1.5",
  "@holo-js/auth-social-linkedin": "^0.1.5",
  "@holo-js/auth-workos": "^0.1.5",
  "@holo-js/authorization": "^0.1.5",
  "@holo-js/broadcast": "^0.1.5",
  "@holo-js/cache": "^0.1.5",
  "@holo-js/cache-db": "^0.1.5",
  "@holo-js/cache-redis": "^0.1.5",
  "@holo-js/cli": "^0.1.5",
  ...
  "@holo-js/flux": "^0.1.5",
  "@holo-js/flux-react": "^0.1.5",
  "@holo-js/flux-svelte": "^0.1.5",
  "@holo-js/flux-vue": "^0.1.5",
  "@holo-js/forms": "^0.1.5",
  "@holo-js/mail": "^0.1.5",
  "@holo-js/media": "^0.1.5",
